...
<head>
    ...
    <title>Regularized Spanish</title>
              ...
              <ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a href="outline_new.html">Transcription</a></li>
                    <li><a href="reg_tabs.html">Modernized Spanish</a></li>	
					<li class="divider"></li>
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a href="glossary.html">Latin glossary</a></li>
                ...
                <div class="container">
                    <h1>Regularized Spanish and transcription</h1>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <ul id="myTab" class="nav nav-tabs" role="tablist">
                                    <li class="active">
                                        <a href="#original" role="tab" data-toggle="tab">Original Transcription</a></li>
                                    <li><a href="#modern" role="tab" data-toggle="tab">Modern Spanish</a></li>
                                </ul>
                                <div id="myTabContent" class="tab-content">
                                    <div class="tab-pane fade in active" id="original">
                                        <xsl:apply-templates select="*except(reg)"></xsl:apply-templates>
                                    </div>
                                    <div class="tab-pane fade" id="modern">
                                        <xsl:apply-templates select="*except(orig)"></xsl:apply-templates>
                                    </div>
                                </div>
                            </div>
                        </div>
