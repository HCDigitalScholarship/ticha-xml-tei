...
<xsl:template match="text">
      <html lang="en">
            ...
            <body>
                ...
                <div class="container">
                       <!-- Below is just a test to make sure the document function is working. -->
                        <!--<div class="jumbotron">
                            This is all just here to test some variables. 
                        Original docuent<xsl:copy-of select="document('interlinears.xml')//linp:linp/linp:html[1]/linp:body[1]/linp:div[1]"/>
                        New interlinsboot document <xsl:copy-of select="document('interlinsboot.xml')/linp:linp/linp:html[1]/linp:body[1]/linp:div[1]"/>
                        Tableid variable<xsl:value-of select="$tableid"/>
                        </div>-->
                     <xsl:apply-templates/> 
                </div>
...
<xsl:template match="div">
     <!-- <li>To make this work, I'll need to match on the divs where there is only one dot in the xml:id, and then create copies of the 
    divs below before closing the li. For each div with multiple dots, create an  <li><copy of select="."> </li></li> -->
